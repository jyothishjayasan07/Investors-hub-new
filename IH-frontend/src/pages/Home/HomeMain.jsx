      ...
      <div className="space-y-16 pt-8 ">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50 rounded-3xl p-8 md:p-16">
          ...
          <div className="relative text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
              InvestorHub brings companies and investors together on a single
              platform, making fundraising and investment opportunities
          ...
          {[
            {
              ...
              title: "For Companies",
              description:
                "Showcase your projects and connect with potential investors worldwide",
            },
            {
              icon: <TrendingUp className="h-10 w-10 text-green-600" />,
              title: "For Investors",
              description:
                "Discover promising investment opportunities and track performance metrics",
            },
            {
              icon: <Users className="h-10 w-10 text-purple-600" />,
              title: "Network",
              description:
                "Build meaningful relationships with industry professionals and experts",
            },
            {
              icon: <Calendar className="h-10 w-10 text-red-600" />,
              title: "Schedule Meetings",
              description:
                "Easily coordinate and schedule investment meetings with built-in tools",
            },
          ].map((feature, index) => (
            <div
              key={index}
            ...
            >
              <div
                className="mb-6 p-3 rounded-xl w-fit bg-opacity-10"
                style={{
                  backgroundColor: `${
                    feature.icon.props.className.split("text-")[1]
                  }20`,
                }}
              >
                {feature.icon}
        ...
        <section className="bg-gray-900 text-white rounded-3xl p-8 md:p-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Join thousands of successful companies and investors who have
            ...
            {[
              {
                ...
                description:
                  "Companies showcase projects, investors set preferences",
              ...
              },
              {
                ...
                description:
                  "Smart matching algorithm connects relevant parties",
              ...
              },
              {
                ...
                title: "Meet & Invest",
                description:
                  "Schedule meetings and complete secure transactions",
        ...
        <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-3xl p-8 md:p-16 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-2xl mx-auto mb-8">
            Join InvestorHub today and take the first step towards your next big
            opportunity
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
