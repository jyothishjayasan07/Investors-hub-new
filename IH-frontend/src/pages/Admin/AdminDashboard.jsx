...
import { AlertCircle, BarChart3, Folder, User } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-6 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <AdminShowcars name="Total Users" total="1,240" icon={<User />} style="text-blue-600" />
          <AdminShowcars name="Projects" total="245" icon={<Folder />} style="text-green-600" />
          <AdminShowcars name="Investments" total="$8.5M" icon={<BarChart3 />} style="text-indigo-600" />
          <AdminShowcars name="Reports" total="24" icon={<AlertCircle />} style="text-red-600" />
        </div>

        {/* Section Based on Sidebar Selection */}
        {display === 'project' && (
          <div>
            <h2 className="text-xl font-semibold text-gray-700 mb-4">Manage Projects</h2>
        ...
        {display === 'reports' && (
          <div className="bg-white p-6 rounded-xl text-center shadow">
            ...
            <p className="text-gray-600">View and manage user-generated reports here.</p>
          </div>
        )}
      </div>
    </div>
